...
<!-- <div class="container"> -->
    ...
    <div class="control-group">
     ...
     <div class="control-group">	
    	 <label class="control-label" for="input01">发现时间</label>
               <div class="controls" >
                    <input size="10" type="text" value="" readonly class="input-large input-append date form_date" data-date="" data-date-format="yyyy-MM-dd">
    ...
    <div class="control-group">
      ...
      <option>其他问题O-Others </option></select>
          </div>
